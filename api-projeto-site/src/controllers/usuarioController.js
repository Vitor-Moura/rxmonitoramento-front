...
function cadastrar(req, res) {
    ...
    var email = req.body.email;
    var nivelPermissao = req.body.nivelPermissao;
    var senha = req.body.senha;
    ...
    if (nome == undefined) {
        ...
        res.status(400).send("Seu nível de permissão está undefined!");
    } else if (senha == undefined) {
        ...
        usuarioModel.cadastrar(nome, email, nivelPermissao, senha, fkSetor, fkSupervisor)
        .then(
            function (resultado) {
                res.json(resultado);
            }
